...
export function Products() {
  ...
  const products = useMemo(
    () => [
      {
        name: t("products.printCutSpread"),
        desc: t("products.printCutSpreadDesc"),
        image: "/images/danhmuc/he thong may cadcam.png",
        link: "/san-pham/may-in-phay-trai-cat",
      },
      {
        name: t("products.automation"),
        desc: t("products.automationDesc"),
        image: "/images/danhmuc/he thong may tu dong.png",
        link: "/san-pham/may-tu-dong-va-robot",
      },
      {
        name: t("products.programmable"),
        desc: t("products.programmableDesc"),
        image: "/images/danhmuc/may may tu dong.png",
        link: "/san-pham/may-may-cong-nghe",
      },
      {
        name: t("products.industrial"),
        desc: t("products.industrialDesc"),
        image: "/images/danhmuc/may may cong nghiep.png",
        link: "/san-pham/may-may-cong-nghiep",
      },
      {
        name: t("products.auxiliary"),
        desc: t("products.auxiliaryDesc"),
